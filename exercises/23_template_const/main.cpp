...
#include <cstring>
#include <numeric>
// READ: 模板非类型实参 <https://zh.cppreference.com/w/cpp/language/template_parameters#%E6%A8%A1%E6%9D%BF%E9%9D%9E%E7%B1%BB%E5%9E
...
private:
	...
	for (unsigned int i = N; i-- > 0;) {  // 从最后一个维度开始
            ASSERT(indices[i] < shape[i], "Invalid index");
            index += indices[i] * multiplier;
            multiplier *= shape[i];  // 更新 multiplier
        }
        return index;
    }
};
